...
CRITICAL: If the user asks about anything unrelated to Pest & Disease Diagnosis, politely refuse and state that your expertise is limited to Pest & Disease Diagnosis."""
