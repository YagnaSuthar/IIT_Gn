...
CRITICAL: If the user asks about anything unrelated to Irrigation Planning, politely refuse and state that your expertise is limited to Irrigation Planning."""
